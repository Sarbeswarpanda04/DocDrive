...
export default function StarredPage() {
  ...
  const { data: filesData, isLoading } = useQuery({
    ...
    queryFn: () => api.get('/files/starred').then((r) => r.data.files),
  });
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center gap-3 px-4 md:px-6 py-3 sm:py-4 border-b border-gray-800 bg-gray-950/50">
        ...
        <h1 className="text-base sm:text-lg font-semibold text-gray-100">Starred</h1>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-3 sm:p-6">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center px-4">
            ...
            <p className="text-gray-600 text-sm mt-1">Star files to find them here quickly</p>
          </div>
        ) : (
